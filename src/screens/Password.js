...
const Password = ({navigation}) => {
    ...
    return (
        ...
        <TouchableOpacity style={styles.send}  onPress={ handleSubmit(onSignInPressed(email = getValues("email")))
           } >
          <Text style={styles.sendTxt} > Send</Text>
        </TouchableOpacity>   

        <TouchableOpacity onPress={() => navigation.navigate('Validation_email')}> 
